...
/**
 * Servlet implementation class BillsReport
 */
public class BillsReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String VisitIDKey = request.getParameter("VisitIDKey");
		System.out.println("VisitIDKey---"+VisitIDKey);
		...
		Connection conn = Helper.getConnection();
	      ...
	      try {
			...
			String sql = "select * from Bill_details_view where Visit_ID =  "+VisitIDKey+";";
